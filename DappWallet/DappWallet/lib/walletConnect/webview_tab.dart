...
class _WebViewTabState extends State<WebViewTab> with WidgetsBindingObserver {
  ...
  void dispose() {
    ...
    widget.webViewModel.url = WebUri("https://pancakeswap.finance/swap");
  ...
  InAppWebView _buildWebView() {
    ...
    return InAppWebView(
      initialUrlRequest:
          URLRequest(url: WebUri("https://pancakeswap.finance/swap")),
      ...
      onWebViewCreated: (controller) async {
        ...
        // try {
        //   if (!ConstantClass.cacheCleared) {
        //     log('hre clearing cache');
        //     controller.clearCache();
        //     setState(() {
        //       ConstantClass.cacheCleared = true;
        //     });
        //   }
        // } catch (e) {
        //   log('Errir clearing cache --> $e');
        // }
      ...
      shouldOverrideUrlLoading: (controller, navigationAction) async {
        ...
        if (url != null &&
            !["http", "https", "file", "chrome", "data", "javascript", "about"]
                .contains(url.scheme)) {
          if (url.toString().startsWith('wc:')) {
            _onFoundUri(url.toString());
      ...
      onDownloadStartRequest: (controller, url) async {
        //  ToastMessage.showToast(null, 'Unable to download', Colors.red);
      },
